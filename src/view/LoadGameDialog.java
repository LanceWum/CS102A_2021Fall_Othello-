...
public class LoadGameDialog extends JDialog {
    ...
    public LoadGameDialog(){
        ...
        okBtn.addActionListener(e -> {
            ...
            setVisible(false);
            //GameFrame.controller.setGame(gid);
            //HistoryGameDialog hisGameDlg = new HistoryGameDialog(gid);
            //hisGameDlg.setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
            //hisGameDlg.setVisible(true);
        });
